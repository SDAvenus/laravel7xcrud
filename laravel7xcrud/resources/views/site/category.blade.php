                                    ...
                                    <div class="col-lg-4">
                                        <div class="product__discount__item">
                                            <div class="product__discount__item__pic set-bg"
                                                 data-setbg='{{ asset("storage/$product->product_image") }}'>
                                            ...
                                            <div class="product__discount__item__text">
                                                ...
                                                <h5><a class="text-info" href='{{ url("/detail/$product->id") }}'>{{ $product->product_name }}</a></h5>
                                                <div class="product__item__price text-danger ">${{ $product->product_discount }} <span>${{ $product->product_price }}</span></div>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="banner__pic">
                        <img src="{{asset('fe-assets/img/banner/banner-3.jpg')}}" alt="" width="400"
                        height="225">
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="banner__pic">
                        <img  src="{{asset('fe-assets/img/banner/banner-4.jpg')}}" alt="" width="400" height="225">
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="banner__pic">
                        <img  src="{{asset('fe-assets/img/banner/banner-5.jpg')}}" alt="" width="400" height="225">
                    </div>
                </div>
            </div>
        </div>
