                    ...
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="checkout__input">
                                    <p>Email<span>*</span></p>
                                    <input type="text" name="customer_email">{{Auth::user()->email}}
                                </div>
                            </div>
                            @else
                            <div class="col-lg-6">
                            ...
                            <ul>
                                ...
                                @if($products)
                                    @foreach($products as $product)
                                         ...
                                         @endif
                                         @if($product->product_status ==1)
                                             <li class="text-primary">{{ $product->product_name }} <span>${{ $cart[$product->id][0]['quantity'] * $product->product_price }}</span></li>
                                        @else
                                            <li class="text-danger">{{ $product->product_name }} <span>${{ $cart[$product->id][0]['quantity'] * 0 }}</span></li>
                                         @endif
                                    @endforeach
                                @endif
                            </ul>
