...
@csrf 
    ...
    <div class="form-group">
        ...
        <input type="text" name="product_publish" style="width: 250px" class="form-control" id="product_publish" value="{{ $product->product_publish }}">
    </div>

    <div class="form-group">
        <label for="product_quantity">Tồn kho sản phẩm:</label>
        <input type="number" name="product_quantity" style="width: 250px" class="form-control" id="product_quantity" value="{{ $product->product_quantity }}">
    </div>

    <div class="form-group">
        <label for="product_price">Giá sản phẩm:</label>
        <input type="text" name="product_price" style="width: 250px" class="form-control" id="product_price" value="{{ $product->product_price }}">
    </div>

    <div class="form-group">
        <label for="product_price">Giá khuyến mại:</label>
        <input type="text" name="product_discount" style="width: 250px" class="form-control" id="product_discount" value="{{ $product->product_discount }}">
    </div>
